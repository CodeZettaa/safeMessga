...
import { isServerReady, isSupabaseConfigured } from '@/lib/env';
...
export default async function AskPage() {
  ...
  const databaseReady = isServerReady() || isSupabaseConfigured();
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-12">
      ...
      <div className="mt-8">
        <AskForm categories={categories} databaseReady={databaseReady} />
      </div>
    </div>
  );
}
